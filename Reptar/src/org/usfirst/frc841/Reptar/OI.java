...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("PhotonCannonOn", new PhotonCannonOn());
        SmartDashboard.putData("PhotonCannonOff", new PhotonCannonOff());
