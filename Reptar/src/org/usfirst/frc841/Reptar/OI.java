...
public class OI {
    ...
    public JoystickButton bringInBall;
    ...
    public OI() {
        ...
        stopIntake = new JoystickButton(coDriver, 4);
        stopIntake.whileHeld(new StopIntakeLowerShooter());
        bringInBall = new JoystickButton(coDriver, 2);
        bringInBall.whileHeld(new IntakeBallLowShooter());
        shoot = new JoystickButton(coDriver, 6);
        ...
        SmartDashboard.putData("SetIntakeAngle: Intake", new SetIntakeAngle(90));
        SmartDashboard.putData("SetIntakeAngle: Ground", new SetIntakeAngle(270));
