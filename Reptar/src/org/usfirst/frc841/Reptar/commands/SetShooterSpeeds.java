...
public class SetShooterSpeeds extends Command {
	...
	protected void initialize() {
		// Gets off set so it can be tuned on the fly
		double offset = Robot.shooter.getDriverStationOffset();

		// Set goal for PID to follow
		Robot.shooter.uppercloop.updateSetpoint(m_UpperSpeed + offset);
		Robot.shooter.lowercloop.updateSetpoint(m_LowerSpeed + offset);
	...
	protected boolean isFinished() {
		...
		return Robot.shooter.lowercloop.isDestinationReached() && Robot.shooter.uppercloop.isDestinationReached()
				|| (!Robot.shooter.lowercloop.isPIDEnabled() && !Robot.shooter.uppercloop.isPIDEnabled());
