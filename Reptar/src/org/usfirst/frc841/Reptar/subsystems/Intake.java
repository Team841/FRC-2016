...
public class Intake extends Subsystem {
	...
	private double DistancePerPulse = 360 / 1024;
    ...
    private final Encoder elbowQuadEncoder = RobotMap.intakeElbowQuadEncoder;
	...
	public double getCurrentAngle() {
		if (getResetSensor()) {
			elbowQuadEncoder.reset();
		}
		return elbowQuadEncoder.getDistance();
	}
	...
	public void initSensor() {
		elbowQuadEncoder.setReverseDirection(false);
		elbowQuadEncoder.setDistancePerPulse(DistancePerPulse);
		elbowQuadEncoder.reset();
	}
