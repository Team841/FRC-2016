...
public class Drivetrain extends Subsystem {
    ...
    class loop implements Runnable{
		...
		public void run() {
			...
			if(drivetrain.isPathFollowEnable){
				...
				drivetrain.SetLeftRight(0.86*1/5.4 *drivetrain.path.smoothLeftVelocity[counter][1]
    ...
    /**
     * This method is here to assign the driver joystick to the style drive. You can choose between 
     * Cheesy style drive of Tank Drive. 
     * @param stick
     */
    ...
    /**
     * This method takes in object joystick and returns the yaxis value of the left most side of the gamepad. 
     * @param stick
     * @return yAxis 
     */
    ...
    /**
     * This method takes in the object joystick and returns the x axis value to the right most side of the gamepad.
     * @param stick
     * @return xAxis
     */
    ...
    /**
     * This method takes in the object joystick and returns the y axis value to the left most side of the gamepad.
     * @param stick
     * @return yAxis
     */
    ...
    /**
     * This method takes inthe ojbect joystick and returns the y axis value to the right most siide of the gamepad. 
     * @param stick
     * @return
     */
    ...
    /**
     * This method takes in the driver controller and allows for tank style drive of the robot. 
     * A smoothness function is done to allow for a smoother control.
     * @param stick
     */
  ...
  /**
   * This method returns the distance in feet from the left quadrature measurement. 
  ...
  /**
   * This method returns the distance in feet from the right quadrature measurement. 
  ...
  /**
   * This method takes in the left and right speeds and averages out to give a total forward moving speed. 
  ...
  public double getRightSpeed(){
   ...
   /**
    *  This method reads the network table variable to see if the castle goal is present or not.
    ...
    */
    ...
    /**
     * This method takes in the the two x limits of the castle goal from the network table and gives the middle  
    ...
    /**
     * This method provides the distance between the robot and the castle from the network table. 
