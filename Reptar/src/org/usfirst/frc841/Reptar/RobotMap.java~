...
public class RobotMap {
    ...
    public static GearTooth shooterHighWheelSpeedSensor;
    public static GearTooth shooterLowWheelSpeedSensor;
    public static SpeedController shooterLowWheel;
    public static SpeedController shooterHighWheel;
    ...
    public static void init() {
        ...
        shooterHighWheelSpeedSensor = new GearTooth(5, false);
        LiveWindow.addSensor("Shooter", "HighWheelSpeedSensor", shooterHighWheelSpeedSensor);
        
        shooterLowWheelSpeedSensor = new GearTooth(4, false);
        LiveWindow.addSensor("Shooter", "LowWheelSpeedSensor", shooterLowWheelSpeedSensor);
        
        shooterLowWheel = new VictorSP(5);
        LiveWindow.addActuator("Shooter", "LowWheel", (VictorSP) shooterLowWheel);
        
        shooterHighWheel = new VictorSP(4);
        LiveWindow.addActuator("Shooter", "HighWheel", (VictorSP) shooterHighWheel);
